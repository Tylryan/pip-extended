...
Move this file inside your top most project directory.
    ...
    def update_asu(self):
        ...
        update_command = "wget -O ~/.local/bin/pipe https://github.com/Tylryan/pip-extended/raw/main/dist/pipe_dev && chmod 744 ~/.local/bin/pipe"
        print("Copy and paste this in your terminal\n")
